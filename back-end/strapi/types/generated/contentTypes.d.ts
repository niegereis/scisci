...
export interface ApiAboutProjectAboutProject
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_projects';
  info: {
    description: '';
    displayName: 'About Project';
    pluralName: 'about-projects';
    singularName: 'about-project';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    aboutProjectDescription: Schema.Attribute.Blocks;
    aboutProjectImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    aboutProjectTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-project.about-project'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAcademicPublicationAcademicPublication
  extends Struct.CollectionTypeSchema {
  collectionName: 'academic_publications';
  info: {
    description: '';
    displayName: 'Academic Publication';
    pluralName: 'academic-publications';
    singularName: 'academic-publication';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    academicPublicationJornal: Schema.Attribute.String;
    academicPublicationLink: Schema.Attribute.String;
    academicPublicationTitle: Schema.Attribute.String;
    academicPublicationYear: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::academic-publication.academic-publication'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    academic_publications: Schema.Attribute.Relation<
      'manyToMany',
      'api::academic-publication.academic-publication'
    >;
    academicStatus: Schema.Attribute.String;
...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blogDescripition: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sci_sci_project: Schema.Attribute.Relation<
      'manyToOne',
      'api::sci-sci-project.sci-sci-project'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSciSciProjectSciSciProject
  ...
  info: {
    description: '';
    displayName: 'SciSci Project';
    pluralName: 'sci-sci-projects';
    singularName: 'sci-sci-project';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-project.about-project': ApiAboutProjectAboutProject;
